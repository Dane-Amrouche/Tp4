...
class Temperature_sensor(Objet):
    ...
    def __init__(self,unitID, subID, MQTT_PUB_TOPIC="1r1/014/temp",MQTT_SUB_TOPIC="1r1/014/temp/command",MQTT_SERVER="192.168.0.206",MQTT_PORT=1883,FREQUENCY=60, *args, **kwargs):
        self.subID = subID
